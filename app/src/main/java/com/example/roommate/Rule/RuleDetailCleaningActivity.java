...
public class RuleDetailCleaningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rule_detail_cleaning);
        ...
        rule_modify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RuleDetailCleaningActivity.this, RuleModifyCleaningActivity.class);
