...
public class RuleDetailLifestyleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rule_detail_lifestyle);
        ...
        rule_modify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RuleDetailLifestyleActivity.this, RuleModifyLifestyleActivity.class);
