...
public class RuleDetailNoiseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rule_detail_noise);
        ...
        rule_modify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RuleDetailNoiseActivity.this, RuleModifyNoiseActivity.class);
